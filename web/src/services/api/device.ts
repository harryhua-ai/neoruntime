...
export const deviceApi = {
  ...
  getNetworkConfig: () => request.get('/api/v1/device/network/config'),
  updateNetworkConfig: (config: Record<string, unknown>) => request.post('/api/v1/device/network/config', config),

  getStorageInfo: () => request.get('/api/v1/device/storage/info'),
  formatStorage: (path: string) => request.post('/api/v1/device/storage/format', { path }),
