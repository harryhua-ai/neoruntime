  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous:
          'absolute left-1 top-0 z-10 h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100',
        button_next:
          'absolute right-1 top-0 z-10 h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100',
