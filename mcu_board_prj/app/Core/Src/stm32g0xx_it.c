...
void EXTI2_3_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(PLS1_Pin);
  HAL_GPIO_EXTI_IRQHandler(PLS2_Pin);
...
void EXTI4_15_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(Z_RST_Pin);
  HAL_GPIO_EXTI_IRQHandler(F_RST_Pin);
  HAL_GPIO_EXTI_IRQHandler(ALARM_IN0_Pin);
  HAL_GPIO_EXTI_IRQHandler(ALARM_IN1_Pin);
