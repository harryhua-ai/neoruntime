...
typedef struct {
    ...
    ms41908m_state_t zoom_state;    /* Zoom and focus cannot run simultaneously */
...
ms41908m_state_t ms41908m_get_zoom_state(void);         /* Zoom and focus cannot run simultaneously */
