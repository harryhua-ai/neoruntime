...
func (h *MediaHandlers) SetConfig(c *gin.Context) {
	...
	outData, err := yaml.Marshal(oldConfig)
	if err != nil {
...
func (h *MediaHandlers) UpdatePrivacyMaskConfig(c *gin.Context) {
	...
	if req.BlurRadius != nil {
		protoReq.BlurRadius = *req.BlurRadius
	}
	if req.DpmEnabled != nil {
		protoReq.DpmEnabled = *req.DpmEnabled
	}
	if req.DpmLabels != nil {
		protoReq.DpmLabels = *req.DpmLabels
	}
	if req.DpmMode != nil {
		protoReq.DpmMode = *req.DpmMode
	}
	if req.DpmColor != nil {
		protoReq.DpmColor = *req.DpmColor
	}
	if req.Regions != nil {
